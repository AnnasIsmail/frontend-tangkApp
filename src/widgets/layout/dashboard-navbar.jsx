...
import Cookies from "js-cookie"; // Import js-cookie untuk token
import {
          ...
          <Menu>
            <MenuHandler>
              <Button
                variant="text"
                color="blue-gray"
                className="items-center gap-1 px-4 normal-case flex"
              >
                <UserCircleIcon className="h-5 w-5 text-blue-gray-500" />
                <span className="hidden xl:inline">{user?.nama}</span>
              </Button>
            </MenuHandler>
            <MenuList>
